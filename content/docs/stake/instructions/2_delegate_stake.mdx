...
The `DelegateStake` instruction delegates all SOL in a stake account (minus rent-exempt reserve) to a validator.
The stake begins warming up at the next epoch boundary.

...
The `Initialize` instruction sets up a stake account's metadata including the stake authority, withdraw authority, and lockup configuration.
The account must be created (via System Program) before initialization.

...
The `Split` instruction creates a new stake account with a portion of the source account's funds.
The new account inherits the delegation state of the source.
